...
wire [0:0] reset_en;
   ...
   always @ (negedge resetn or posedge clk ) begin 
       if ((resetn == 1'b0)) 
           begin 
               begin /* variable_assignment  predec_ctrl__lock  has moved. */ end 
               ar_dec_i <= 1'b0;
           end
   ...
   always @ (negedge resetn or posedge clk ) begin 
       if ((resetn == 1'b0)) 
           begin 
               begin /* variable_assignment  p_status_reg__sreg_mem  has moved. */ end 
               begin /* variable_assignment  p_status_reg__sreg_mem_tmp  has moved. */ end 
           end
   ...
   always @ (negedge resetn or posedge clk ) begin 
       if ((resetn == 1'b0)) 
           begin 
               begin /* variable_assignment  exword_counter__src_tmp  has moved. */ end 
               begin /* variable_assignment  exword_counter__dest_tmp  has moved. */ end 
               begin /* variable_assignment  exword_counter__lock  has moved. */ end 
           end
   ...
   always @ (negedge resetn or posedge clk ) begin 
       if ((resetn == 1'b0)) 
           begin 
               begin /* variable_assignment  movem_ctrl__bit_pnt  has moved. */ end 
               begin /* variable_assignment  movem_ctrl__regsel_tmp  has moved. */ end 
               movem_pi_corr <= 1'b0;
           end
